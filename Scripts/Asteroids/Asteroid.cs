...
namespace Asteroids
{
    ...
    public class Asteroid : MonoBehaviour
    {
        ...
        public AsteroidScriptableObject asteroidData;
       ...
       [Header("References:")]
        ...
        {
            var force = Random.Range(asteroidData._minForce, asteroidData._maxForce);
            finalForce = force;
        ...
        {
            var torque = Random.Range(asteroidData._minTorque, asteroidData._maxTorque);
        ...
        {
            var size = Random.Range(asteroidData._minSize, asteroidData._maxSize);
            finalSize = size;
